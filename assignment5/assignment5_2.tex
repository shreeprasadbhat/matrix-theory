...
\end{equation}
Set $x = X + \alpha$ and $y = Y + \beta$, then \eqref{eq1} becomes,
\begin{equation}\label{eq2}
	\left.	
	\begin{aligned}
		aX^2 + 2bXY + cY^2\\
		+ 2(a\alpha + h\beta + d)X + 2(h\alpha + b\beta + e)Y\\
		+ (a\alpha^2 + 2h\alpha\beta + b\beta^2 + 2d\alpha + 2e\beta + f)
	\end{aligned}
	\right\} = 0
\end{equation}
Last term on the left hand side of \eqref{eq2} can also be written as
\begin{equation}\label{eq3}
	\alpha(a\alpha + h\beta + d) + \beta(h\alpha + b\beta + e) + (d\alpha + e\beta + f)
\end{equation}
\section{Solution}
\end{document}
