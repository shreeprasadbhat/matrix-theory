...
\begin{abstract}
This document proves properties on double dual 
\end{abstract}
Download latex-tikz from
\begin{lstlisting}
https://github.com/shreeprasadbhat/matrix-theory/blob/master/assignment14/
\end{lstlisting}
%
\section{Problem}
...
\section{Pictorial representation of problem}
\begin{figure}[h!]
\centering
\includegraphics[scale=0.4]{fig/vector_space.png}
\caption{Vector space of all function $V$ and it's $n$-dimensional subspace $W$}
\end{figure}
\pagebreak
\begin{figure}[h!]
\centering
\includegraphics[width=\columnwidth]{fig/f.png}
\caption{Functions $f_1,f_2,\dots,f_n$ where $f:S \rightarrow F$ and $f_i(x_i) = \delta_{ij}$ for $i=0,1,\dots,n$}
\end{figure}
\pagebreak
\section{Solution}
\begin{table}[h!]
