...
\end{table}
\section{Figure}
Consider $x_1=1, x_2=0$, where $\{x_1, x_2\} \in S$.\\
Let $f_1(x) = x, f_2(x) = 1-x$ where $\{f_1, f_2\} \in W$.\\
\begin{figure}[h!]
\includegraphics[width=\columnwidth]{fig/fig.png}
\caption{Pictorial representation of functions and points in vector space}
\end{figure}
\end{document}