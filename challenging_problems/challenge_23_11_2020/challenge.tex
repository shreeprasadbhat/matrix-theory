...
\\
To move the figure to origin, put $y = y - \frac{1}{2}$, \eqref{eq4} becomes
\begin{equation}\label{eq5}
	\vec{x}^T \myvec{9 & 0 & -3\\0 & -4 & 0\\-3 & 0 & 1}\vec{x} = 0
\end{equation}
To make coordinate axis parallel to figure axis, perform $spectral$ $decomposition$ on \eqref{eq5}, 
