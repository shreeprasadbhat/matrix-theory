...
\begin{lstlisting}
https://github.com/shreeprasadbhat/matrix-theory/blob/master//challenging_problems/challenge3/
\end{lstlisting}
%
\section{Problem}
...
\begin{align}
    \label{eq1}\angle{ABC}&=\angle{ACB}\\
    \label{eq1}\cos\angle{ABC} &= \cos\angle{ACB}\\
    \label{eq2}\frac{(\vec{B}-\vec{A})^T(\vec{B}-\vec{C})}{\norm{\vec{B}-\vec{A}}\norm{\vec{B}-\vec{C}}} &= \frac{(\vec{C}-\vec{A})^T(\vec{C}-\vec{B})}{\norm{\vec{C}-\vec{A}}\norm{\vec{C}-\vec{B}}}\\
    \label{eq3}\frac{(\vec{B}-\vec{A})^T(\vec{B}-\vec{C})}{\norm{\vec{B}-\vec{A}}} &= \frac{(\vec{C}-\vec{A})^T(\vec{C}-\vec{B})}{\norm{\vec{C}-\vec{A}}}
\end{align}
It can be showed that,
% \norm{\vec{B}}^2 - \vec{B}^T\vec{C} - \vec{A}^T\vec{B} + \vec{A}^T\vec{C}
% $\norm{\vec{B}}^2 = \norm{\vec{A}-\vec{B}}^2 - \norm{\vec{A}}^2 + 2\vec{A}^T\vec{B}$
\begin{align}
    \label{eq4}(\vec{B}-\vec{A})^T(\vec{B}-\vec{C}) &= \norm{\vec{A}-\vec{B}}^2 - (\vec{A}-\vec{C})^T(\vec{A}-\vec{B})\\
    \label{eq5}(\vec{C}-\vec{A})^T(\vec{C}-\vec{B}) &= \norm{\vec{A}-\vec{C}}^2 - (\vec{A}-\vec{C})^T(\vec{A}-\vec{B})
\end{align}
Substituting \eqref{eq4} and \eqref{eq5} in \eqref{eq3},
\begin{align}
    ...
    \implies\norm{\vec{A}-\vec{B}} &= \norm{\vec{A}-\vec{C}}
\end{align}
Hence we proved that sides opposite to equal angles of triangle are equal.
\end{document}