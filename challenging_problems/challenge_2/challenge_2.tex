...
\begin{equation}
    P = \myvec{1\\1\\0} - \frac{7}{59}\myvec{2\\-1\\1}
\end{equation}
\begin{equation}
    P = \myvec{1\\1\\0} - \myvec{\frac{14}{59}\\\frac{-7}{59}\\\frac{7}{59}}
\end{equation}
\begin{equation}
    P = \myvec{\dfrac{45}{59}\\\dfrac{66}{59}\\\dfrac{-7}{59}} = \myvec{0.763\\1.119\\0.119}
\end{equation}
Substituting $\lambda{_2}$ in equation \eqref{eq5}
\begin{equation}
    Q = \myvec{2\\1\\-1} - \frac{25}{59}\myvec{3\\-5\\2}
\end{equation}
\begin{equation}
    Q = \myvec{2\\1\\-1} - \myvec{\frac{75}{59}\\\frac{-125}{59}\\\frac{50}{59}}
\end{equation}
\begin{equation}
    Q = \myvec{\dfrac{43}{59}\\\dfrac{184}{59}\\\dfrac{-109}{59}} = \myvec{0.729\\3.119\\-1.847}
\end{equation}
\begin{figure}[h]
    \centering
