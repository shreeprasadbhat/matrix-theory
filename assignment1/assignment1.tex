...
\item Scalar product of two vectors a and b is defined as\\
\begin{equation}
\vec{a^Tb}=\myvec{a_1&a_2& \ldots\ a_n} \myvec{b_1\\b_2\\ \vdots \\b_3}    
...
\item Vector product can be expressed as product of a skew-symmetric matrix and vector\\
