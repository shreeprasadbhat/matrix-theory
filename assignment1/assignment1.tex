...
\vspace{3cm}
\title{Matrix theory - Assignment1}
...
\begin{abstract}
This  document  illustrates  scalar  and  vector  productsof two vectors
\end{abstract}
...
%
\begin{lstlisting}
https://github.com/shreeprasadbhat/matrix-theory/blob/master/assignment1/
\end{lstlisting}
%
\section{Problem}
\\
\item Find scalar and vector products of the two vectors\\
$
\vec{a} = \myvec{3\\-4\\5},\;
\vec{b} = \myvec{-2\\1\\-3}$
...
$\vec{ab^T}\;=\;\myvec{a_1\\a_2\\a_3} \;  \myvec{b_1\\b_2\\b_3}^T$= \myvec{a_1\times b_1+ a_2\times b_2 + a_3 \times b_3}
\subsection{Vector product}
Vector product can be expressed as product of a skew-symmetric matrix and vector\\\\
$\vec{a \times b} \;=\; \myvec{0 & a_3 & a_2\\ a_3& 0 &-a_1 \\ -a_2 & a_1 & 0 } \myvec{b_1\\b_2\\b_3}$
\section{Solution}
\subsection{Scalar product}
$\vec{ab^T}\;=\;\myvec{3\\-4\\5} \myvec{-2\\1\\-3}^T$

$\;=\;\myvec{3\times -2\;+\;-4\times 1\;+\;5\times -3}\;=\;-25$
\subsection{Vector product}\\\\\\\
$\vec{a \times b} \;&=\; \myvec{0 & 5 & -4\\ 5 & 0 & -3\\ -(-4) & 3 &  0} \myvec{-2\\1\\3}$
\\\\\\
$&\vec{a \times b} \; = \; \myvec{(0 \times -2) \; + \; (-5 \times 1) \; + \; (-4 \times -3)\\(5 \times -2) \; + \; (0 \times 1) \; + \; (-3 \times -3)\\
